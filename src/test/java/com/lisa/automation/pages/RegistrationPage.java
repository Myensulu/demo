...
import static com.lisa.automation.common.constants.PropertyNames.REGISTER_URL;
...
public class RegistrationPage extends BasePage {
    ...
    private final By PASSWORD_REG_TEXTBOX = By.xpath("//input[@id='password']");
    private final By CONFIRM_PASSWORD_TEXTBOX = By.xpath("//input[@id='confirm_password']");
